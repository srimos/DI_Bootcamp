...
function userMultipliedBy2 (userArray){
    return userArray.map(([user,value])=>[user,value*2])
}
console.log(userMultipliedBy2(userArray))
...
if ([2] === [2]) {console.log(true)} else {console.log(false)} // false
...
console.log(object4.number) //5 because object 4 is not the same as object 1
